...
<br />
<div align="center">
  <a href="https://github.com/siekman-io/ansible-tutorial/install-http">
    <img src="https://siekman.io/images/logo.png" alt="Logo" width="80" height="80">
  </a>

  <h3 align="center">install-http</h3>

  <p align="center">
    install a simple webserver 
    <br />
    <a href="https://github.com/siekman-io/ansible-tutorial/install-http"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
[![Product Name Screen Shot][product-screenshot]](https://siekman.io/github/ansible-tutorial/install-http/scr_install-http.jpg)

install a webserver on a specific operating system

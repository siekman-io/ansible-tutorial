...
<br />
<div align="center">
  <a href="https://github.com/siekman-io/ansible-tutorial/installmysql">
    <img src="https://siekman.io/images/logo.png" alt="Logo" width="80" height="80">
  </a>

  <h3 align="center">installmysql</h3>

  <p align="center">
    playbook to install a mysql server 
    <br />
    <a href="https://github.com/siekman-io/ansible-tutorial/installmysql"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
[![Product Name Screen Shot][product-screenshot]](https://siekman.io/github/ansible-tutorial/installmysql/scr_installmysql.jpg)

the easy way to create a nice playbook
